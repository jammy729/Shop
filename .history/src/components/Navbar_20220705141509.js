...
const Navbar = () => {
  return (
    <Box>
      <Container centerContent maxW='100vw' bg='green'>
        <Stack direction='row' pt={8}>
          ...
          <Box align='right' flex={3} px={6}>
            <Box flex={2} display={{ base: 'none', lg: 'inline-block' }}>
              <Menu>
                <MenuButton
                  boxSize='3rem'
                  as={IconButton}
      ...
      {/* MOBILE NAVBAR  */}
      <Box align='right' flex={3} px={6}>
        <Box flex={1} display={{ base: 'none', lg: 'inline-block' }}>
          <Menu>
            <MenuButton
              boxSize='3rem'
              as={IconButton}
        ...
        <Box flex={1} display={{ base: 'inline-block', lg: 'none' }}>
          <Menu isLazy>
            <Link to='./cart'>
              <IconButton boxSize='3rem' mx={1} icon={<FaShoppingCart />} />
            </Link>
            <MenuButton
              boxSize='3rem'
              as={IconButton}
